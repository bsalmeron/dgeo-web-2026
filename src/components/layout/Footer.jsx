          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <a
                  href="mailto:info@dgeosoluciones.com"
                  className="text-sm text-gray-400 hover:text-orange-400 transition-colors"
                >
                  info@dgeosoluciones.com
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <Phone className="h-5 w-5 text-orange-400 flex-shrink-0 mt-0.5" />
                <a
                  href="tel:+50622836697"
                  className="text-sm text-gray-400 hover:text-orange-400 transition-colors"
                >
                  (506) 2283-6697
                </a>
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-400">
                  Emma Gamboa, San Pedro, San José, Costa Rica
                </span>
              </li>
            </ul>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col items-center md:items-start space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Sitio en fase de pruebas - Desarrollado por Ing. Brayner Salmerón
              </p>
            </div>
