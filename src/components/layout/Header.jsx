...
const Header = () => {
  ...
  const navLinks = [
    ...
    { name: 'Blog', path: '/blog', hash: '', scrollTo: null },
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <img
              src="https://sensible-spoonbill-485.convex.cloud/api/storage/be58cd4c-27a9-4bdd-9ff5-2e4b8a252aeb"
              alt="D'GEO Soluciones"
